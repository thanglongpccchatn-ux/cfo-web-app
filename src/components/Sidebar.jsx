...
export default function Sidebar({ isSidebarOpen = true, setIsSidebarOpen }) {
    ...
    const tabs = [
        ...
        { id: 'labor_tracking', icon: 'engineering', label: 'Theo dõi Nhân công', perms: ['view_labor', 'manage_labor'] },
        ...
        { id: 'suppliers', icon: 'local_shipping', label: 'Nhà cung cấp & Vật tư', perms: ['view_partners', 'manage_partners', 'view_materials', 'manage_materials_tracking'] },
        ...
        { id: 'site_diary', icon: 'edit_calendar', label: 'Nhật ký hiện trường', perms: ['view_construction', 'manage_construction'] },
