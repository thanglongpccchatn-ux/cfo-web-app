...
export default function IncomeStatementDashboard({ filter, data }) {
    return (
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 min-h-full">
            <h1 className="text-2xl font-black text-blue-800 mb-6 uppercase">Báo cáo Kết quả Hoạt động Kinh doanh</h1>
