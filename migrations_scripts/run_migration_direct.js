...
const sqlFilePath = 'e:/AG/cfo-web-app/supabase/migrations/add_internal_vat.sql';
...
async function run() {
    ...
    console.log("\n❌ Could not connect to the database in any known region. Password might be incorrect or IPv4 disabled.");
}
